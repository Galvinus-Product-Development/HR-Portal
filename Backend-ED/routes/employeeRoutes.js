...
router.get("/fetchEmployeeByUserId/:userId", employeeController.fetchEmployeeByUserId);
...
router.get("/employmentt/:userId", employeeController.getEmploymentDetailss);
